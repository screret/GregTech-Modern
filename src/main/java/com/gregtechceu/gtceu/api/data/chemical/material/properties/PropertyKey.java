...
public class PropertyKey<T extends IMaterialProperty> {
    ...
    public static final PropertyKey<EmptyProperty> EMPTY = new PropertyKey<>("empty", EmptyProperty.class,
            EmptyProperty::new, Codec.unit(EmptyProperty::new));
