...
public class SPacketSyncBedrockOreVeins implements GTNetwork.INetPacket {
    ...
    public SPacketSyncBedrockOreVeins(FriendlyByteBuf buf) {
        ...
        Stream.generate(() -> {
            ...
            BedrockOreDefinition def = BedrockOreDefinition.DIRECT_CODEC.parse(ops, tag).getOrThrow(false,
                    GTCEu.LOGGER::error);
    ...
    public void encode(FriendlyByteBuf buf) {
        ...
        for (var entry : veins.entrySet()) {
            ...
            CompoundTag tag = (CompoundTag) BedrockOreDefinition.DIRECT_CODEC.encodeStart(ops, entry.getValue())
